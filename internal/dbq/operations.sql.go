...
const enqueueOperationWork = `-- name: EnqueueOperationWork :exec
INSERT INTO work_queue (resource_id, task_type, op_id, kind, generation, spec, provider_config, provider_bundle, shard_id)
SELECT r.id, 'operate'::task_type, $1, r.kind, r.generation, r.spec,
...
func (q *Queries) EnqueueOperationWork(ctx context.Context, arg EnqueueOperationWorkParams) error {
	_, err := q.db.Exec(ctx, enqueueOperationWork, arg.OpID, arg.ResourceID)
	return err
}
